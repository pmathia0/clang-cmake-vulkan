...
RUN wget -O VulkanSDK.tar.gz https://sdk.lunarg.com/sdk/download/1.2.141.0/linux/vulkansdk-linux-x86_64-1.2.141.0.tar.gz?u=true && \
     mkdir VulkanSDK && \
     cd VulkanSDK && \
     tar xvf /VulkanSDK.tar.gz

RUN	cd VulkanSDK/1.2.141.0
ENV	VULKAN_SDK="/VulkanSDK/1.2.141.0/x86_64:${VULKAN_SDK}"
